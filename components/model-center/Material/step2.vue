<template>
    <div class="flex flex-col gap-4 mt-3">
      <div class="bg-white rounded-[8px] md:px-10 md:py-8 p-4">
        ...
        <div class="flex gap-10 mt-5 mb-4">
          ...
          <div class="flex gap-2 items-center">
            <Label for="isComfirmation">是否可视频确认样品</Label><Switch id="isComfirmation" />
          </div>
        </div>
        <div class="flex gap-4 items-center flex-wrap">
          <div
            class="border-[1px] border-[#eeeeee] rounder-[4px] flex justify-between items-center p-4 flex-1"
          >
        ...
        <div class="grid md:grid-cols-4 grid-cols-2 lg:gap-x-10 gap-x-5 gap-y-4 mt-6 mb-3">
          ...
          <div class="flex flex-col gap-1.5">
            <div>
              <span class="apply-text">广告分发总数</span
          ...
          <div class="flex flex-col gap-1.5 col-span-2">
            <div>
              <span class="apply-text">分发商户数</span
              ><span class="text-[#FF5030] ml-[2px] pt-2">*</span>
            </div>
            <div class="flex gap-2 items-center">
              <Input type="text" placeholder="请输入" class="flex-1 rounded-[4px]" /><span
                class="apply-text"
                >每</span
              >
              <Input type="text" placeholder="请输入" class="flex-1 rounded-[4px]" /><span
        ...
        <div class="flex flex-col gap-1.5">
          <div>
            <span class="apply-text">选择意向分发商户分类领域</span
            ><span class="text-[#FF5030] ml-[2px] pt-2">*</span>
          </div>
          <div>
            <Select>
        ...
        <div class="flex flex-col gap-1.5 my-4">
          <div>
            <span class="apply-text">截止时间</span
            ><span class="text-[#FF5030] ml-[2px] pt-2">*</span>
          </div>
          <div>
            <MyDate></MyDate>
          ...
          <div>
            ...
            ><span class="danger-text">交付周期为4天</span>
            <span class="danger-text !text-[#666666]">，从广告制作商</span
            ><span class="danger-text">快递到各广告分发商需要3天</span>
            <span class="danger-text !text-[#666666]">，如果今天</span
            ><span class="danger-text">2024-4-21</span>
            <span class="danger-text !text-[#666666]">下单，预计</span
            ><span class="danger-text">2024-4-29</span>
    ...
    <div
        class="fixed left-0 right-0 bottom-0 bg-white h-16 flex justify-center items-center px-8"
      >
