<template>
  ...
  <ScrollArea class="flex-1 overflow-auto">
    <div
      class="w-[100vw] px-4 relative md:px-8 lg:px-12 box-bWallet md:w-full min-h-[calc(100vh-76px)] flex flex-col"
    >
      <div class="flex flex-col flex-1">
        ...
        <div v-if="tabactive == 0" class="flex-1 flex flex-col">
          <div v-if="Wallet.pager.lists" class="flex flex-col flex-1">
